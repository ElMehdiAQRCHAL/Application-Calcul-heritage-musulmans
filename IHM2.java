...
public class IHM2 {
	...
	private void initialize(JFrame frame,int i) {
		...
		panel.setLayout(null);
			...
			lblNewLabel_55.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\PFA (2)\\PFA\\image3.jpg - Paint.png"));
			...
			lblNewLabel_56.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\PFA (2)\\PFA\\tekstura_staroy_korichnevoy_bumagi-1024.jpg"));
...
////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			lblNewLabel_73.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\PFA (2)\\PFA\\image3.jpg - Paint.png"));
			lblNewLabel_73.setBounds(284, 21, 401, 193);
			panel1.add(lblNewLabel_73);
			
			JLabel lblNewLabel_100 = new JLabel("");
			lblNewLabel_100.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\PFA (2)\\PFA\\image3.jpg - Paint.png"));
		...
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\PFA (2)\\PFA\\tekstura_staroy_korichnevoy_bumagi-1024.jpg"));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(rdbtnNewRadioButton_1.isSelected()==true || rdbtnNewRadioButton.isSelected()==true) {
					...
					String  title[] = {"نصيبه","النسبة المئوية","عددالأسهم", "الوارث"};
					...
					lblNewLabel_23.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\PFA (2)\\PFA\\tekstura_staroy_korichnevoy_bumagi-1024.jpg"));
		...
		JButton rdbtnNewRadioButton80  = new JButton("حساب");
		...
		rdbtnNewRadioButton80.setFont(new Font("Traditional Arabic", Font.BOLD, 20));
		rdbtnNewRadioButton80.setBounds(541, 390, 160, 50);
		panel5.add(rdbtnNewRadioButton80);
		
		JButton rdbtnNewRadioButton81  = new JButton("إغلاق");
		...
		rdbtnNewRadioButton81.setFont(new Font("Traditional Arabic", Font.BOLD, 20));
		rdbtnNewRadioButton81.setBounds(300, 390,  160, 50);
		panel5.add(rdbtnNewRadioButton81);
		
		
		
		JLabel lblNewLabel81 = new JLabel("");
		lblNewLabel81.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\PFA (2)\\PFA\\image3.jpg - Paint.png"));
		lblNewLabel81.setBounds(300, 180, 401, 193);
		panel5.add(lblNewLabel81);
		
		JLabel lblNewLabel80 = new JLabel("");
        lblNewLabel80.setForeground(Color.BLACK);
		lblNewLabel80.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\PFA (2)\\PFA\\tekstura_staroy_korichnevoy_bumagi-1024.jpg"));
		lblNewLabel80.setBounds(-21, 0, 1209, 697);
